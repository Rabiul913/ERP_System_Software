...
<a href="{{ route('employee-releases.create') }}" class="btn btn-out-dashed btn-sm btn-warning"><i class="fas fa-plus"></i></a>
@endsection
@section('sub-title')
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="icon-btn">
                        <nobr>
                            <a href="{{ route('employee-releases.edit', $data->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-outline-warning"><i class="fas fa-pen"></i></a>
                            <form action="{{ url("hr/employee-releases/$data->id") }}" method="POST" data-toggle="tooltip" title="Delete" class="d-inline">
                                @csrf
                                @method('DELETE')
