            ...
            @foreach($sections as $key => $section)
                <tr>
                    ...
                    <td>
                        <div class="icon-btn">
                            <nobr>
                                <a href="{{ route('sections.edit', $section->id) }}" data-toggle="tooltip" title="Edit" class="btn btn-outline-warning"><i class="fas fa-pen"></i></a>
                                <form action="{{ url("hr/sections/$section->id") }}" method="POST" data-toggle="tooltip" title="Delete" class="d-inline">
                                    @csrf
                                    @method('DELETE')
