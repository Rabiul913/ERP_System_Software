        ...
        <div style="width: 50%; float:left;">
            <div style="margin-top: 20px;">
                ...
                <p style="font-size: 12px; text-align: center; font-weight: bold;text-transform: uppercase; ">
                    {{ $search_criteria["Product"] != "All" ? "Product Wise " : ($search_criteria["Category"] != "All" ? "Category Wise " : '') }}Delivery Challan Report ({{ $search_criteria["Product"] != "All" ? $search_criteria["Product"] : ($search_criteria["Category"] != "All" ? $search_criteria["Category"] : '') }})
...
<div>
    ...
    @if(count($reportData))
            ...
            <div>
                ...
                <div>
                    <table class="customers">
                        ...
                        <tbody>
                            @foreach ($data as $deliveryChallanDetail)
                            <tr>
                                <td style="width: 10%;" class="text-center">DCN-{{ $deliveryChallanDetail->deliveryChallan?->id }}</td>
                                <td style="width: 10%;" class="text-center">DO-{{ $deliveryChallanDetail->deliveryChallan?->delivery_order_id }}</td>
                                <td style="width: 10%;" class="text-center">{{ $deliveryChallanDetail->productSize?->name }}</td>
                                <td style="width: 10%;" class="text-center">{{ $deliveryChallanDetail->measuringUnit?->name }}</td>
                                <td style="width: 10%;" class="text-right">{{ $deliveryChallanDetail->quantity }}</td>
                                <td style="width: 10%;" class="text-center">{{ date('d-M-Y', strtotime($deliveryChallanDetail->deliveryChallan?->delivery_date)) }}</td>
                                <td style="width: 15%;" class="">{{ $deliveryChallanDetail->deliveryChallan?->customer?->name }}</td>
                                <td style="width: 15%;" class="">{{ $deliveryChallanDetail->deliveryChallan?->deliveryOrder?->employee?->emp_name }}</td>
                                <td style="width: 10%;" class="">{{ $deliveryChallanDetail->deliveryChallan?->deliveryOrder?->zone?->zone }}</td>
                                @php
                                    $sub_total += ($deliveryChallanDetail->quantity);
                                @endphp
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4" class="text-right" style="width: 40%; font-weight:bold;">Sub-total</td>
                                <td style="width: 10%;" class="text-right">{{ $sub_total }}</td>
        ...
        <table class="customers" style="margin-top: 10px;">
            ...
            <tbody>
                <tr>
                    <td colspan="4" class="text-right" style="width: 40%; font-weight:bold;">Grand-total</td>
                    <td style="width:10%;" class="text-right">{{ $grand_total }}</td>
                    <td style="width: 10%;" class="text-right"></td>
                    <td style="width: 15%;" class="text-right"></td>
                    <td style="width: 15%;" class="text-right"></td>
                    <td style="width: 10%;" class="text-right"></td>
