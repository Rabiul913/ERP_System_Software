        ...
        <div style="width: 50%; float:left;">
            <div style="margin-top: 20px;">
                ...
                <p style="font-size: 12px; text-align: center; font-weight: bold;text-transform: uppercase; ">
                    {{ $search_criteria["Product"] != "All" ? "Product Wise " : ($search_criteria["Category"] != "All" ? "Category Wise " : '') }}Sales Report ({{ $search_criteria["Product"] != "All" ? $search_criteria["Product"] : ($search_criteria["Category"] != "All" ? $search_criteria["Category"] : '') }})
                ...
                <div>
                    <table class="customers">
                        ...
                        <tbody>
                            ...
                            <tr>
                                {{-- dd() --}}
                                <td style="width: 12%;" class="text-center">{{ date('d-M-Y', strtotime($deliveryOrderDetail->deliveryOrder?->date)) }}</td>
                                <td style="width: 15%;" class="">{{ $deliveryOrderDetail->deliveryOrder?->customer?->name }}</td>
                                <td style="width: 15%;" class="">{{ $deliveryOrderDetail->deliveryOrder?->employee?->emp_name }}</td>
                                <td style="width: 12%;" class="text-center">DO-{{ $deliveryOrderDetail->deliveryOrder?->id }}</td>
                                <td style="width: 12%;" class="text-center">{{ $deliveryOrderDetail->deliveryOrder?->zone?->zone }}</td>

                                <td style="width: 12%;" class="text-center">{{ $deliveryOrderDetail->quantity }}</td>
                                <td style="width: 12%;" class="text-right">@money($deliveryOrderDetail->unit_price)</td>
                                <td style="width: 10%;" class="text-right">@money($deliveryOrderDetail->quantity * $deliveryOrderDetail->unit_price)</td>
                                @php
