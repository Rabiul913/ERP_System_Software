...
<body>
        ...
        <div style="width: 50%; float:left;">
            <div style="margin-top: 20px;">
                ...
                <p style="font-size: 12px; text-align: center; font-weight: bold; ">
                    Report of {{ date('M-Y', strtotime($month)) }}
                </p>
    ...
    <div class="container">
        @if(count($employee_target_report_data))
            <table id="customers">
                <thead>
                    <tr>
                        <th>SL No.</th>
                        ...
                        <th>Target Differences</th>
                    </tr>
                </thead>
                <tbody>

                    @foreach ($employee_target_report_data as $key => $data)
                        <tr>
                            <td>{{ $key+1 }}</td>
                            <td>{{ $data->emp_name }}</td>
                            <td class="text-right">@money( $data->monthly_target )</td>
                            <td class="text-right">@money( $data->monthly_sale )</td>
                            <td class="text-right">@money( $data->monthly_collection )</td>
                            <td class="text-right">@money( $data->monthly_sale - $data->monthly_target )</td>
                        </tr>
                    @endforeach
                ...
                <tfoot>
                    <tr>
                        ...
                        <td class="text-right" style=" font-weight:bold;">@money( $employee_target_report_data->sum('monthly_target') )</td>
                        <td class="text-right" style=" font-weight:bold;">@money( $employee_target_report_data->sum('monthly_sale') )</td>
                        <td class="text-right" style=" font-weight:bold;">@money( $employee_target_report_data->sum('monthly_collection') )</td>
                        <td class="text-right" style=" font-weight:bold;">@money( $employee_target_report_data->sum('monthly_sale') -$employee_target_report_data->sum('monthly_target') )</td>
